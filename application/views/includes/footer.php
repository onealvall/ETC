        <!-- Footer-->
        <footer class="footer py-4" style="background-color: #000; color: #fff; height: 1000px; font-size: 22px; text-align: left;">
            ...
            <div class="container" style="margin-top: 100px; margin-bottom: 100px;">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4">
                        ...
                        <br>
                        <div> <i class="fa-solid fa-envelope"></i> info@eteleconnectinc.com</div>
                        <div> <i class="fa-solid fa-phone"></i> Telephone</div>
                        <br>
                        <div> Direct: US line (855) 800-0710</div>
                        <div>Tel. No: (632) 829-0703 loc.102/114</div>
                     </div>
                     <div class="col-lg-4">
                        <div>USA</div>
                        <br>
                        <div> E91-1037 Kai Weke Street</div>
                        <div> Ewa Beach, HI 96706</div>
                        <div>Tel No: (808) 445-6527</div>
                        <div>Direct: US line 855.800.0710 ext. 801</div>
                     </div>
                     <div class="col-lg-4">
                        <div>PHILIPPINES</div>
                        <br>
                        ...
                        <br>
                        <div>
                        2nd Floor, Olivarez Sports Center,
                        Dr. A. Santos Avenue, Sucat Road,
                        Parañaque City, Philippines 1700 
                       </div>
                        <div>Tel. No: 63.968.893.7999</div>
                        <div>63.8829.0703 loc 102</div>
                        <div>Laguna</div>
                        <br>
                        <div>
                            2nd Floor, Olivarez Plaza
        ...
        <div class="portfolio-modal modal fade" id="portfolioModal2" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="close-modal" data-bs-dismiss="modal"><img src="<?php echo base_url() ?>/ssets/img/close-icon.svg" alt="Close modal" /></div>
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="modal-body">
